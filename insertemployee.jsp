...
<%
					...
					PreparedStatement ps = connection	
							.prepareStatement("INSERT INTO employee(name,pass,email,mobile,addr,dob,gender,pin,location,experience,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?,?) ");
					...
					if (x > 0) {
						...
						response.sendRedirect("employeelogin.jsp?msg=null");
%>
