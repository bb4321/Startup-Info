    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		<p class="infopost"><a href="#" class="com style2">Start Up Details</a></p>
          <div class="clr"></div>
		  <br><br>
<form id="formsearch" name="formsearch" method="post" action="searchaction.jsp">
            <span>
		...
		Statement st1 = connection.createStatement();
				ResultSet rs = st1.executeQuery("select * from company where name like '"+name+"' or field='"+name+"' or addr='"+name+"'");
		%>
...
<td width="93"><div align="center" class="style8"><%=rs.getString(2)%></div></td>
		 ...
		 <td width="52"><div align="center" class="style8"><a href="deletecompany.jsp?id=<%=rs.getString(4)%>">Delete</a></div></td>
		 </tr>
		 <%
}
		 %>
