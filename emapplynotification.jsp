...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <form action="emapplyaction.jsp" method="post" enctype="multipart/form-data">  
<br/> </td></tr>
			 <table>
			 
			 <tr><td>Resume Upload</td><td><input type="hidden" name="cname" value="<%=request.getParameter("id")%>"></tr>
			 <tr><td><input type="hidden" name="field" value="<%=request.getParameter("field")%>"></td></tr>
			 <tr><td>Select File:</td><td><input type="file" name="fname"/><br/> </td></tr>
			 <tr><td>
