...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<p class="infopost"><a href="#" class="com style2">Student Details</a></p>
          <div class="clr"></div>
		  <br><br>
		<%
		...
		%>
  	   ...
  	   <tr>
   		 <td width="93"><div align="center" class="style8">Student Name </div></td>
...
<td width="93"><div align="center" class="style8"><%=rs.getString(2)%></div></td>
		 ...
		 <td width="52"><div align="center" class="style8"><a href="deletestudent.jsp?id=<%=rs.getString(4)%>">Delete</a></div></td>
		 </tr>
		 <%
}
		 %>
