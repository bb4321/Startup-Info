	...
	try {
		...
		while (params.hasMoreElements()) {
			...
			if (paramname.equalsIgnoreCase("qualification")) {
				intr = multi.getParameter(paramname);
			}
...
<%
					...
					PreparedStatement ps = connection	
							.prepareStatement("INSERT INTO student(name,pass,email,mobile,addr,dob,gender,pin,location,qualification,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?,?) ");
					...
					if (x > 0) {
						...
						response.sendRedirect("studentlogin.jsp?msg=null");
%>
