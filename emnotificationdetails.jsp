...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
         <li class="active"><a href="employeehome.jsp"><span>Home Page</span></a></li>
         <li><a href="employeeprofile.jsp"><span>Profile</span></a></li>
          <li><a href="emviewstartup.jsp"><span>StartUp 	</span></a></li>
          
          <li><a href="emnotificationdetails.jsp"><span>Notification Details </span></a></li>
		  <li><a href="emsearch.jsp"><span>Search</span></a></li>
    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		Statement st1 = connection.createStatement();
				ResultSet rs = st1.executeQuery("select * from notification");
		%>
         ...
         <td width="72"><div align="center" class="style8">Job Description</div></td>
		 <td width="72"><div align="center" class="style8">Email Id</div></td>
         
		 <td width="52"><div align="center" class="style8">Location</div></td>
		 <td width="52"><div align="center" class="style8">Last Date</div></td>
...
<td width="93"><div align="center" class="style8"><%=rs.getString(2)%></div></td>
    	 <td width="71"><div align="center" class="style8"><%=rs.getString(3)%></div></td>
         <td width="72"><div align="center" class="style8"><%=rs.getString(4)%></div></td>
         <td width="52"><div align="center" class="style8"><%=rs.getString(5)%></div></td>
		 ...
		 <td width="52"><div align="center" class="style8"><a href="emapplynotification.jsp?id=<%=rs.getString(2)%>&field=<%=rs.getString(3)%>">Apply</a></div></td>
		 </tr>
		 <%
}
		 %>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
       <li class="active"><a href="employeehome.jsp">Home Page</a></li>
         <li><a href="employeeprofile.jsp">Profile</a></li>
          <li><a href="emviewstartup.jsp">StartUp 	</a></li>
          
          <li><a href="emnotificationdetails.jsp">Notification Details </a></li>
		  <li><a href="emsearch.jsp">Search</a></li>
		  <li><a href="index.html"><span>Logout</span></a></li>
