...
<%
    ...
    %>
    <script>alert('Resume Accepted Successfully');</script>
    <%            }
    %>
    ...
    %>
    <script>alert('Resume Rejected ');</script>
    <%            }
    %>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		<p class="infopost"><a href="#" class="com style2">View Resume</a></p>
          <div class="clr"></div>
		  <br><br>
		<%
		String name=(String)session.getAttribute("cuser");
		Statement st1 = connection.createStatement();
				ResultSet rs = st1.executeQuery("select * from resume");
		%>
         ...
         <td width="72"><div align="center" class="style8">Name</div></td>
		 <td width="72"><div align="center" class="style8">Email</div></td>
		 <td width="72"><div align="center" class="style8">Phone</div></td>
         <td width="52"><div align="center" class="style8">Resume Download</div></td>
...
<td width="93"><div align="center" class="style8"><%=rs.getString(2)%></div></td>
         ...
         <td width="72"><div align="center" class="style8"><%=rs.getString(4)%></div></td>
         <td width="72"><div align="center" class="style8"><%=rs.getString(5)%></div></td>
		 <td width="72"><div align="center" class="style8"><%=rs.getString(6)%></div></td>
		 
		 <td width="52"><div align="center" class="style8"><a href="download.jsp?fname=<%=rs.getString(7)%>">Download</a></div></td>
		 <td width="52"><div align="center" class="style8"><a href="acceptresume.jsp?user=<%=rs.getString(5)%>">Accept</a>|<a href="rejectresume.jsp?user=<%=rs.getString(5)%>">Reject</a></div></td>
  ...
  <p class="infopost"><a href="#" class="com style2">Applications</a></p>
          <div class="clr"></div>
		  <br><br>
		<%
		
		Statement st2 = connection.createStatement();
				ResultSet rs1= st2.executeQuery("select * from apply");
		%>
         <table border="1" align="center" cellpadding="10" cellspacing="0" bordercolor="#162D3D">
  	   <tr>
   		 <td width="93"><div align="center" class="style8">Company Name </div></td>
    	 <td width="71"><div align="center" class="style8">Job Description </div></td>
		 <td width="71"><div align="center" class="style8">Field </div></td>
         <td width="72"><div align="center" class="style8">Name</div></td>
		 <td width="72"><div align="center" class="style8">Email</div></td>
		 <td width="72"><div align="center" class="style8">Phone</div></td>
         <td width="52"><div align="center" class="style8">Resume Download</div></td>
...
%>
<tr>
<td width="93"><div align="center" class="style8"><%=rs1.getString(2)%></div></td>
    	 <td width="71"><div align="center" class="style8"><%=rs1.getString(3)%></div></td>
         <td width="72"><div align="center" class="style8"><%=rs1.getString(4)%></div></td>
         <td width="72"><div align="center" class="style8"><%=rs1.getString(5)%></div></td>
		 <td width="72"><div align="center" class="style8"><%=rs1.getString(6)%></div></td>
		 <td width="72"><div align="center" class="style8"><%=rs1.getString(7)%></div></td>
		 
		 <td width="52"><div align="center" class="style8"><a href="download.jsp?fname=<%=rs1.getString(8)%>">Download</a></div></td>
		 <td width="52"><div align="center" class="style8"><a href="acceptapply.jsp?user=<%=rs1.getString(6)%>">Accept</a>|<a href="rejectapply.jsp?user=<%=rs1.getString(6)%>">Reject</a></div></td>
