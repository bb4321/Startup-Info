    ...
    <div class="content_resize">
      <div class="mainbar">
		...
		Statement st1 = connection.createStatement();
				ResultSet rs = st1.executeQuery("select * from company where status='yes'");
		%>
...
<td width="93"><div align="center" class="style8"><%=rs.getString(2)%></div></td>
		 ...
		 <td width="52"><div align="center" class="style8"><a href="emapplyresume.jsp?id=<%=rs.getString(2)%>">Apply</a></div></td>
		 </tr>
		 <%
}
		 %>
