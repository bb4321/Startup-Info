...
<%
    ...
    %>
    <script>alert('Company Registered Successfully');</script>
    <%            }
    %>
<body>
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style1">Company </span><br />
          </h2>
          <p class="infopost"><a href="#" class="com style2">Login</a></p>
          <div class="clr"></div>
          
          <form action="companyauth.jsp" method="post" id="leavereply">
            <ol>
              <li>
                <label for="name">Email Id (required)</label>
